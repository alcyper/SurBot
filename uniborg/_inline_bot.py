...
if Config.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == borg.uid and query.startswith("@UniBorg"):
            ...
            result = builder.article(
                "© @UniBorg",
                text="""@Sur_vivor **( Custom Built By** @Sur_vivor **)** 
**Verified Account:** ✅
...
**Custom Built Fork:** https://github.com/Sur-vivor/SurBot""",
                buttons=[
                    [custom.Button.url("👤Contact Creator👤", "https://telegram.dog/Sur_vivor"), custom.Button.url(
                        "📼Ravana Audio Memes📼", "https://t.me/tgaudiomemes")],
                    [custom.Button.url("👨‍💻Source Code👨‍💻", "https://github.com/Sur-vivor/SurBot"), custom.Button.url(
                        "❕❗Deploy Me❗❕", "https://dashboard.heroku.com/new?button-url=android-app%3A%2F%2Forg.telegram.messenger&template=https%3A%2F%2Fgithub.com%2FSur-vivor%2FSurBot")],
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == borg.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Please get your own @Sur_vivor, and don't edit my messages!"
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
