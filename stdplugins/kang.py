...
async def _(event):
    ...
    packshortname = f"✰Sᴀͥʀᴀͣᴛͫʜ™️✰-Survivor{userid}"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"✰Sᴀͥʀᴀͣᴛͫʜ™️✰-AnimatedStickers"
        packshortname = f"✰Sᴀͥʀᴀͣᴛͫʜ™️✰-Animated"  # format: Uni_Borg_userid
